		...
		<div class="center_content">
			<div class="left_content">
				...
				<div class="feat_prod_box_details">
					<p class="details"><img alt="" src="images/register.jpg" width="450" height="100"></p>
					<div class="contact_form">
						...
						<s:form action="register">
							...
							<div>
								<s:textfield name="userEmail" label="邮箱"></s:textfield>
							</div>
							<div>
								<s:textfield name="userName" label="真实姓名"></s:textfield>
							</div>
							<div>
								<s:textfield name="userSex" label="性别"></s:textfield>
							</div>
							<div>
								<s:textfield name="userSchool" label="学校"></s:textfield>
							</div>
							<div>
								<s:textfield name="userPhone" label="电话"></s:textfield>
							</div>
							<div>
									<s:checkbox label="我已阅读并同意" name="legal"></s:checkbox>
							</div>
							<div>
								<s:submit value="确认" calss="register"></s:submit>
							</div>
						</s:form>
					</div>
				</div>
