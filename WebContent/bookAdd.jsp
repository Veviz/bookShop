...
<%
    ...
    String str4 = "医学类";
    String str5 = "建筑类";
    LinkedList<String> kindList = new LinkedList<String>();
    kindList.add(str1);
    kindList.add(str2);
    kindList.add(str3);
    kindList.add(str4);
				...
				<div class="left_content">
					...
					<div class="feat_prod_box_details">
						...
						<div class="contact_form">
							<div class="form_subtitle">增添书籍</div>
							<s:form action="bookAdd" theme="simple"
								enctype="multipart/form-data">
								<table align="center" width="50%" border="0">
									<tr>
										<td><strong>书名</strong></td>
										<td><s:textfield name="bookName"></s:textfield>
										</td>
									</tr>
									<tr>
										<td><strong>种类</strong></td>
										<td><s:select list="%{#session.kindList}"
										headerKey="书籍种类"
										headerValue="书籍种类"
										key="kind"
										name="bookKind"></s:select>
										</td>
									</tr>
									<tr>
										<td><strong>新旧</strong></td>
										<td><s:radio list="#{'1':'新书','0':'旧书' }"
												name="newOrUsed"></s:radio>
										</td>
									</tr>
									<tr>
										<td><strong>作者</strong></td>
										<td><s:textfield name="authorName"></s:textfield>
										</td>
									</tr>
									<tr>
										<td><strong>出版社</strong></td>
										<td><s:textfield name="press"></s:textfield>
										</td>
									</tr>
									<tr>
										<td><strong>出版时间</strong></td>
										<td><s:textfield name="publishTime"></s:textfield>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><s:textfield name="stockNum"></s:textfield>
										</td>
									</tr>
									<tr>
										<td><strong>简介</strong></td>
										<td><s:textarea name="briefInfo"></s:textarea>
										</td>
									</tr>
									<tr>
										<td><strong>发布者</strong></td>
										<td><input disabled="disabled"
									  type="text" name="publisherID" value=<%=userID%>>
										</td>
									</tr>
									<tr>
