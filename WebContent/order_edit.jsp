...
<%@ page language="java"
	import="java.util.*,Order.CodeCreator,Order.ShoppingCart,com.book,java.sql.*"
	pageEncoding="UTF-8"%>
<html>
<head>
			...
			<div class="left_content">
				...
				<div class="feat_prod_box_details">
					...
					<div class="contact_form">
						<div class="form_subtitle">填写订单信息</div>
						<%
							 String receiverName = null;
						    String contactWay = null;
						  	String receiveAddr = null;
							CodeCreator order_code = new CodeCreator();
							String accountCode = null;
							String isChange = request.getParameter("ischange");
							session.setAttribute("ischange",isChange);
							//System.out.print((String)session.getAttribute("ischange"));
							if (isChange != null && isChange.equals("true"))
							{
								accountCode = (String) session.getAttribute("ordercode");
								...
								accountCode = order_code.createAccountcode(userID);
								session.setAttribute("ordercode", accountCode);
							}
							String allcost = (String) session.getAttribute("all_cost");
						%>
						<form action="store_order" method="post">
							...
							if(isChange != null && isChange.equals("true"))
							{
							 %>
							<div class="form_row">
								<label class="contact"><strong>收件人:</strong> </label> <input
									type="text" class="contact_input" name="receiverName" value="<%=receiverName %>"/>
							</div>
							<div class="form_row">
								<label class="contact"><strong>联系方式:</strong> </label> <input
									type="text" class="contact_input" name="contactWay" value="<%=contactWay %>" />
							</div>
							<div class="form_row">
								<label class="contact"><strong>收货地址:</strong> </label> <input
									type="text" class="contact_input" name="receiveAddr"  value="<%=receiveAddr %>"/>
							</div>
							<div class="form_row">
							...
							}else
							{
							 ...
							 <div class="form_row">
								<label class="contact"><strong>收件人:</strong> </label> <input
									type="text" class="contact_input" name="receiverName"  />
							</div>
							<div class="form_row">
								<label class="contact"><strong>联系方式:</strong> </label> <input
									type="text" class="contact_input" name="contactWay"  />
							</div>
							<div class="form_row">
								<label class="contact"><strong>收货地址:</strong> </label> <input
									type="text" class="contact_input" name="receiveAddr" />
							</div>
							<div class="form_row">
								<label class="contact"><strong>应付金额:</strong> </label>
								<%=allcost%>
