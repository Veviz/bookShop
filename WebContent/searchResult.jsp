...
<%
	...
	list = (LinkedList<book>) session.getAttribute("searchBook");
	hasBook = (String) session.getAttribute("searchNoBook");
%>
		...
		<div class="header">
			...
			<div id="menu">
				...
				<ul>
					...
					<li><a href="register.htm">帮助</a>
					</li>
					<li><a href="GetShoppingCart.jsp">我的订单</a>
					</li>
				</ul>
				<%
				}
		...
		<div class="center_content">
			<div class="left_content">
				...
				<div class="new_products">
					<s:iterator value="#session.searchBook" var="book">
				...
				}else
				{
				 ...
				 <br>
				 <font color="red" size="3"><br><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 &nbsp;&nbsp;&nbsp;
				 对不起，没有找到您需要的书籍！</font>
				 <%
				 }
