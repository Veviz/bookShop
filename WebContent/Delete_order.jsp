  ...
  <body>
    ...
    <%
        ...
        if(selectedOrder != null)
        {
            ...
            {
                   String sql_delete_order = "delete from orderInfo where userID='"+userID+"' and orderID='"+selectedOrder[i]+"'";
                   dbBean.executeUpdate(sql_delete_order);
                   String sql_delete_order_detail = "delete from orderedBook where orderNumber='"+selectedOrder[i]+"'";
                   dbBean.executeUpdate(sql_delete_order_detail);
            }
        }
