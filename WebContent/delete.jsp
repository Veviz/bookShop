<%@ page contentType="text/html; charset=utf-8" language="java"
	import="java.sql.*,java.util.*,com.book"%>
...
<%
	String delUserID = (String) request.getParameter("delUserID");
...
<body>
	<div id="wrap">
		<div class="header">
			...
			<div id="menu">
				<ul>
					<li class="selected"><a href="shopkeeper.jsp">主页</a>
					</li>
					<li><a href="user.action">用户管理</a>
					</li>
					<li><a href="bookInfo.action">书籍管理</a>
					</li>
			...
			<div class="left_content">
				...
				<div class="feat_prod_box_details">
					...
					<div class="contact_form">
						<div class="form_subtitle">注销用户信息</div>
						<%
						String sql = null;
						sql = "select * from userInfo where userID='" + delUserID + "'";
						DB.connect();
					...
					<br>
					    ...
					    <br>
					    <div>  <a href="user.jsp" class="continue">返回</a> <a
								href="userDel.action?userID=<%=delUserID%>" class="checkout">删除</a>
						</div>
						<%
						}
					%>
